...
For sufficiently smooth likelihoods, a Taylor expansion of
...
standard regularity conditions (existence of bounded third derivatives and dominated
convergence).
...
information theory provide bounds between KL divergence and achievable error
probabilities.
...
Alternative choices of constants based on Pinsker's, Chernoff, or symmetric KL bounds
lead to equivalent definitions that differ only by fixed numerical factors and do not
affect scaling results.
